...
public class TeluguYearActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TeluguYear[] teluguYears = new TeluguYear[]{
                new TeluguYear("1. Pharbava Nama Year","1901 1910 2010 2100"),
                new TeluguYear("2. Pharbava Nama Year","1901 1910 2010 2100"),
                new TeluguYear("1. Pharbava Nama Year","1901 1910 2010 2100"),
        ...
        TeluguYearsAdapter adapter = new TeluguYearsAdapter(teluguYears, activity);
