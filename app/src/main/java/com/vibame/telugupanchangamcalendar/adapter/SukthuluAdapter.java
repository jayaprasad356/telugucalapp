...
public class SukthuluAdapter extends RecyclerView.Adapter<SukthuluAdapter.ViewHolder> {
    Activity activity;
    ArrayList<SakunaluData> sakunaluListDatas;

    public SukthuluAdapter(ArrayList<SakunaluData> sakunaluDatas, Activity activity) {
