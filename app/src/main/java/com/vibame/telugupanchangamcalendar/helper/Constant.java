...
public class Constant {
    ...
    public static final String DATA_LOADING = "0";
    ...
    public static final String POURNAMI = "pournami";
    public static final String AMAVASYA = "amavasya";
    public static final String AKADASHI = "akadhashi";
    public static final String PRADOSHAM = "pradhosha";
    public static final String SHASHTI = "shasti";
    public static final String CHAVITHI = "chavithi";
    public static final String MASASHIVARATRI = "masa_shiva_Rathri";
    ...
    public static final String SUBHA_MUHURTHAM_ID = "subha_muhurtham_id";
    ...
    public static final String OLD_ARTI_IMAGES = "old_arti_image";
    ;
